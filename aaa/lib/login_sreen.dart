...
final _phoneFormatter = TextInputFormatter.withFunction((oldValue, newValue) {
  ...
  String formatted = '+7';
  if (digits.length > 1) formatted += ' ${digits.substring(1, min(4, digits.length))}';
  if (digits.length > 4) formatted += ' ${digits.substring(4, min(7, digits.length))}';
  if (digits.length > 7) formatted += ' ${digits.substring(7, min(9, digits.length))}';
  if (digits.length > 9) formatted += ' ${digits.substring(9, min(11, digits.length))}';
